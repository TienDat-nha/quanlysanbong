    ...
    <section className="admin-owner-fields-container">
      <header className="admin-owner-fields-hero">
        <div className="admin-owner-fields-copy">
          ...
          <p>
            Theo dõi trạng thái phê duyệt, rà soát hồ sơ sân và xử lý nhanh thao tác xóa sân khi
            cần.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <p>
            Không tìm thấy sân nào theo bộ lọc “{selectedFilterLabel}”. Hãy đổi bộ lọc hoặc chờ chủ
            sân gửi hồ sơ mới.
          </p>
        </div>
      ) : (
